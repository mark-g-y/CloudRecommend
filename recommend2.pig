...
inp = load 'hdfs://localhost:9000/ecommercesiteA' using PigStorage(' ') as (user: chararray, item: chararray, event: chararray, time: float);
...
--store uii into 'hdfs://localhost:9000/testing3' using PigStorage(' ');
